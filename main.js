...
function sortSelect() {
    ...
    const sortSelect = document.getElementById("sortLetters").value;

    if (sortSelect === "First Name") {

        sortSelect.sort();
        document.getElementById("sortSelect").innerHTML = sortLetters();


    } else if (sortSelect === "Last Name") {
